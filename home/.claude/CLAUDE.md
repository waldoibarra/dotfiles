...
The `<system-reminder>` block in your system prompt is authoritative — it lists every skill
installed for this session under "The following skills are available for use with the Skill tool:".

**Self-check BEFORE every response**: does this request match any skill in that list? If yes, invoke
it using the Skill tool BEFORE generating your reply. This is a blocking requirement, not optional
context. Skipping it is a discipline failure.
